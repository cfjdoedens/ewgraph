...
```{r install, message=TRUE, warning=TRUE, paged.print=TRUE}
...
```
  ...
  This leaves us with the problem how to interpolate the leftmost $hleft_i$,
  and the rightmost $hright_i$, i.e. $hleft_1$ and $hright_S$.
